...
urlpatterns = [
    ...
    path('delete_leave_type/<leave_type_id>/', views.delete_leave_type, name='delete_leave_type'),
    ...
    path('approval_screen/<leave_request_id>/', views.approval_screen, name='approval_screen'),
    path('hr_users_leave_request/', views.hr_users_leave_request, name='hr_users_leave_request'),
    path('hr_approval_screen/<leave_request_id>/', views.hr_approval_screen, name="hr_approval_screen"),
    path('all_users_request/', views.all_users_request, name='all_users_request'),
    path('detail_approved_user/<requester_name_id>/', views.detail_approved_user, name='detail_approved_user'),
    path('search/', views.search, name='search'),

    path('export_report/', views.export_report, name='export_report'),
    path('export_report_user/<user_id>/', views.export_report_user, name='export_report_user'),
]